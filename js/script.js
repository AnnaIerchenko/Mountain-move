$(document).ready(function(){
    $(window).scroll(function(event){
        ...
        var p = s/h*100;/*prozent prokruch texta*/
        var p_b = s/h_b*100; /*prozent prokruchenogo pervogo ekrana*/ 
        var o = 1-1/100*p_b;/*vichisl buduwyy neprozracnost*/

        var z_1=1+(w/10000*p_b);
     $('.parallax_fog').css('transform','scale('+z_1+')');/*izmenyaem stily css*/
